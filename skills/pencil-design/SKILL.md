...
- **Adding personality, signature moments, or a "polish" pass after the design is functionally complete.** Load `references/delight.md`. It owns the personality-in-functional-moments framing, signature moments, and the discipline that prevents stacked delight from becoming noise.
